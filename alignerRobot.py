...
def useMummerAlign(mummerLink, folderName, outputName, referenceName, queryName, specialForRaw = False, specialName = ""):
    nucmerMummer(specialForRaw, mummerLink, folderName, outputName, referenceName, queryName)
    showCoorMummer(specialForRaw, mummerLink, folderName, outputName, specialName)
    
    

def nucmerMummer(specialForRaw, mummerLink, folderName, outputName, referenceName, queryName):
...
def useMummerAlignBatch(mummerLink, folderName, workerList, nProc ,specialForRaw = False):
    ...
    if not houseKeeper.globalLarge:
        ...
        for eachitem in workerList:
            ...
            results.append(p.apply_async(useMummerAlign, args=(mummerLink, folderName, outputName, referenceName, queryName, specialForRaw , specialName)))
